  ...
  return (
    ...
    >
      <header className="App-header">
        <h2 className="fixed-name">Sicelukwanda Zwane</h2>
        <h1>About me</h1>
        ...
        <p>
          ...
          where I work on developing data-efficient and safety-aware machine learning algorithms for robotics. I am part of the <a href="https://www.sml-group.cc">Sustainability and Machine Learning Group</a> as well as
